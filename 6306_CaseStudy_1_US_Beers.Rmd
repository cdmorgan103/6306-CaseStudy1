...
Here we beigin the process of cleaning our brewrery data. We first trim out white space and lower all text in the brewery data to prevent false positives when searching for duplicates. Next we perform a duplicate analysis that eliminates likely duplicate breweries by searching for rows of data that have the first two words matching in brewery name and the brewery data shares the same city.
...
Duplicate data must share the same beername,brewery name, abv, ibu, and style to be removed.
...
utilizing our joined data, we simply sum NA's and print for each column
